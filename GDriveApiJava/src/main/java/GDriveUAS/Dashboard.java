...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        CreateFolder h = new CreateFolder();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:    int baris = jTable2.getSelectedRow();
    ...
    public DefaultMutableTreeNode getData(String IdFolder) {
            ...
            DefaultMutableTreeNode year = new DefaultMutableTreeNode(folder.getName());
                ...
                for (File folders : googleRootFolders_) {
                    ...
                    /*  List<File> rootGoogleFolders = FindFilesByName.getGoogleFilesByName(folder.getId());//archivos
                       for(File Files:rootGoogleFolders){
                          DefaultMutableTreeNode files = new DefaultMutableTreeNode(Files.getMimeType());
                          day.add(files);
                }*/
                       month.add(day);
                }
